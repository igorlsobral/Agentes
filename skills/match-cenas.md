...
7. Placement:
   ...
   - Otherwise still allowed on every preset. Show the action clearly. Long-form / VSL: do not cover the face unless that beat needs the whole frame. `tiktok-raw` / `short-form-explainer`: the scene may occupy more of the frame at that moment.
